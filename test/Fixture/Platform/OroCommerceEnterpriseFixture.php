...
final class OroCommerceEnterpriseFixture implements FixtureInterface
{
    ...
    {
        yield (new WizardAssertionFixtureProvider(['5.6', '7.1'], 'orocommerce', ['1.6'], true, $this->dbms))
            ...
            ->expectImageBuildProcesses(
                ...
                ['docker', 'build', '--rm', '--tag', new ContextReplacement('kiboko-test/php:%phpVersion%-fpm-orocommerce-ee-%applicationVersion%-%dbms%'), '--build-arg', new ContextReplacement('SOURCE_VARIATION=%phpVersion%-fpm-orocommerce-ce-%applicationVersion%-%dbms%'), '-'],
                ...
                ['docker', 'build', '--rm', '--tag', new ContextReplacement('kiboko-test/php:%phpVersion%-cli-orocommerce-ee-%applicationVersion%-%dbms%'), '--build-arg', new ContextReplacement('SOURCE_VARIATION=%phpVersion%-cli-orocommerce-ce-%applicationVersion%-%dbms%'), '-'],
            )
        ;
        ...
        ;
        yield (new WizardAssertionFixtureProvider(['7.3', '7.4', '8.0'], 'orocommerce', ['3.1'], true, $this->dbms))
            ->expectWizardMessages(
                'Choosing OroCommerce Enterprise Edition, version %applicationVersion%.',
            )
            ->expectImageBuildProcesses(
            ...
            ->withExperimental()
        ;
        yield (new WizardAssertionFixtureProvider(['7.3'], 'orocommerce', ['4.1'], true, $this->dbms))
            ->expectWizardMessages(
                'Choosing OroCommerce Enterprise Edition, version %applicationVersion%.',
            )
            ->expectImageBuildProcesses(
        ...
        ;
        yield (new WizardAssertionFixtureProvider(['8.0'], 'orocommerce', ['4.1', '4.2'], true, $this->dbms))
            ->expectWizardMessages(
                'Choosing OroCommerce Enterprise Edition, version %applicationVersion%.',
            )
            ->expectImageBuildProcesses(
