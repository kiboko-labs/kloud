...
final class NodeJSVersionInvalid implements AssertionFailureInterface
{
    ...
    {
        return sprintf('Version for NodeJS command does not match constraint "%s", found %s.', $this->constraint, $this->version);
    }
}
