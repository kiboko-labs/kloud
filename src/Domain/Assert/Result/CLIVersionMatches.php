...
final class CLIVersionMatches implements AssertionSuccessInterface
{
    ...
    {
        return sprintf('Version for the PHP-CLI command does match constraint "%s", found %s.', $this->constraint, $this->version);
    }
}
