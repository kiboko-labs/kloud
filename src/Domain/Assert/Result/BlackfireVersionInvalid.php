...
final class BlackfireVersionInvalid implements AssertionFailureInterface
{
    ...
    {
        return sprintf('Version for Blackfire command does not match constraint "%s", found %s.', $this->constraint, $this->version);
    }
}
