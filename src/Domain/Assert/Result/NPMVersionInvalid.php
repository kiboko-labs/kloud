...
final class NPMVersionInvalid implements AssertionFailureInterface
{
    ...
    {
        return sprintf('Version for NPM command does not match constraint "%s", found %s.', $this->constraint, $this->version);
    }
}
