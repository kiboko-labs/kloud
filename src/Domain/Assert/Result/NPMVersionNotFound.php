...
final class NPMVersionNotFound implements AssertionUnprocessableInterface
{
    ...
    {
        return 'Could not determine the NPM command version, although the command was found.';
    }
}
