...
final class CLIVersionInvalid implements AssertionFailureInterface
{
    ...
    {
        return sprintf('Version for PHP-CLI command does not match constraint "%s", found %s.', $this->constraint, $this->version);
    }
}
