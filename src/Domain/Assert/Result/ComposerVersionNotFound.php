...
final class ComposerVersionNotFound implements AssertionUnprocessableInterface
{
    ...
    {
        return 'Could not determine the Composer command version, although the command was found.';
    }
}
